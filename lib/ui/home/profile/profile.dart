...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _onLoading() {
    setState(() {
      _loading = true;
      widget.userModel != null ? new Future.delayed(new Duration(seconds: 3), _login) : _loading = false;
    });
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                            ...
                            validator: (value) {
                              if (value.isEmpty || value.length < 5 || _currentpassword == password) {
                            ...
                            decoration: new InputDecoration(
                                errorBorder: InputBorder.none, labelText: 'password', labelStyle: TextStyle(height: 0), fillColor: Colors.white)),
                      ),
                      SizedBox(
                        height: 40,
                      ),
                      Container(
                        ...
                        child: TextFormField(
                            ...
                            validator: (value) {
                              if (value.isEmpty || value.length < 5 || _currentaddress == address) {
                                return 'invalid address';
                              } else {
                                return null;
                              }
                            ...
                            decoration: new InputDecoration(
                                errorBorder: InputBorder.none, labelText: 'address', labelStyle: TextStyle(height: 0), fillColor: Colors.white)),
                      ),
                      SizedBox(
                        height: 50,
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                              backgroundColor: MaterialStateProperty.all<Color>(Color(0xFFECB5FF)),
                              shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                                borderRadius: context.highBorderRadius,
                              ))),
                          onPressed: () {
  ...
  Future<void> _updateUserData() async {
    ...
    if (result == true) {
      _firebaseAuth.currentUser.updatePassword(_currentpassword);
